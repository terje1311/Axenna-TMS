...
echo '<form name="regform" method="POST" action="data/save_customer.php">';
...
<input type="button" onclick="getData(\''.$regnumber.'\',\''.$companyName.'\')" value="'.$LANG['get_data'].'"> &nbsp; 
<input id="but1" style="'.$button_style.'" type="submit" value="'.$button_value.'" '.$button_status.'>
</td></tr>';
