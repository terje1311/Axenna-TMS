...
<tr><td>
<input type="image" style="border:none" src="../images/edit_22.png" onclick="document.location='register_sale.php?orderID=<?php print $orderID;?>';" alt="<?php print $LANG['edit_order']; ?>" title="<?php print $LANG['edit_order']; ?>">
<br>
...
<td>
<input style="width:250px;" name="recipient" type="text" value="<?php print $customerContact; ?>">
</td>
</tr>
...
<td>
<input style="width:250px;" name="recipientEmail" type="text" value="<?php print $companyEmail; ?>">
</td>
</tr>
...
<td>
<input type="button" value="<?php print $LANG['send_order_confirmation'];?> " onchange="">
</td>
</tr>
...
<tr>
<td>
<textarea id="confirmationMail" style="width:700px;height:300px">
