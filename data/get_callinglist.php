...
echo '<form name="regform" method="POST" action="data/save_callinglist.php">';
...
$regnumber = substr($regnumber,0,3).substr($regnumber,4,3).substr($regnumber,8,3);
    ...
    if(!strstr($row->nodeValue, "INAKTIVT")) {  // don't print inaktive companies
			 ...
			 echo '<td style="width:40px;"><a href="data/get_info.php?regnumber='.$regnumber.'" target=_blank>See</a></td>';
