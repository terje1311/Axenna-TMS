...
<table class="ui-widget-content ui-corner-all" style="float:left;margin-right:5px;font-size:13px;height:230px;" align="left">
...
<td>
<select id="statusID" name="orderStatusID" onchange="javaScript:convertOrderStatus('<?php print $Row['orderID'];?>',this.options[this.selectedIndex].value)">
<?php
...
<table class="ui-widget-content ui-corner-all" style="float:left;font-size:13px;height:230px;width:350px">
<tr>
...
<br>
<input type="image" style="border:none" src="images/pdf_32.png" onclick="document.getElementById('iFrame').src='data/create_order_confirmation_pdf.php?outputForm=D&orderID=<?php print $orderID;?>';" title="<?php print $LANG['show_order_confirmation']; ?>">
<br>
...
<td valign="top" align="center">
<br>
<input type="image" style="border:none" src="images/email_32.png" onclick="document.getElementById('iFrame').src='data/order_confirmation.php?orderID=<?php print $orderID;?>';" title="<?php print $LANG['send_order_confirmation']; ?>">
<br>
