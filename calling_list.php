...
xmlhttp.open("GET","data/get_callinglist.php?place="+document.getElementById('sted').value+"&SN2007="+document.callform.SN2007.value,true);
xmlhttp.send();
...
xmlhttp.open("GET","data/display_callinglist_items.php?listID="+listID,true);
xmlhttp.send();
}
...
xmlhttp2.open("GET","data/display_company.php?ID="+ID+"&reg_number="+regNumber,true);
xmlhttp2.send();
}
...
xmlhttp3.open("GET","data/display_callinglists.php",true);
xmlhttp3.send();
}
...
xmlhttp.open("GET","data/get_info.php?regnumber="+regNumber,true);
xmlhttp.send();
document.getElementById("listButton").style.visibility='visible';
...
<iframe src="data/select_location.php" id="selector" style="border:0;width:225px;height:250px;float:left;">

</iframe>

<form name="callform" ID="getForm" method="post" action="data/get_callinglist.php">
...
o.enableFilteringMode(true,"data/complete_branch.php",true);
